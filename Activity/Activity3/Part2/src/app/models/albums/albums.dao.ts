...
export const readAlbumByArtist = async (artistName: string) => {
    return execute<Album[]>(albumQueries.readAlbumByArtist, [artistName]);
};
...
export const readAlbumByDescriptionSearch = async (search: string) => {
    console.log('search param', search);
